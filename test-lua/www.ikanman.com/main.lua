...
s_site_path = 'M:\\GitHubRepositories\\IFComicDownloader\\test-lua\\www.ikanman.com\\'
----------------------------------------------------------------------------------
...
--          1.2.2 - 站点分析脚本
LoadLuaFileList(GetAllLuaFilesInPath('M:\\GitHubRepositories\\IFComicDownloader\\script\\sites\\www.ikanman.com\\'))

--  2 - 正式测试
--      2.0 - 加载伪DownloadURL函数。
dofile('M:\\GitHubRepositories\\IFComicDownloader\\test-lua\\www.ikanman.com\\web\\web.lua')
--      2.1 - 执行待测试的函数
--      Test Case ------------------------------------------------------------------
result, errmsg = ComicUrlAnalyse('http://www.ikanman.com/comic/839/')
if not result then
