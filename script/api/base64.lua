...
function math_pow(b, i)
    if 0 == i then return 1 end
    if 1 == i then return b end
    if 2 == i then return b * b end
    if 1 == i % 2 then return math_pow(b, i - 1) * b end
    return math_pow(math_pow(b, i / 2), 2)
end
math.pow = math_pow
