...
function VolumePageAnalyse_GetVolumeTitle(pagestr)
    local start_index = JumpStr(pagestr, 1, "var qTcms_S_m_playm=\"", 1)
...
function VolumePageAnalyse_GetPictureCount(pagestr)
    ...
    if not start_index then return nil, "VolumePageAnalyse_GetPictureCount failed: no var qTcms_S_m_murl_e=\"" end
